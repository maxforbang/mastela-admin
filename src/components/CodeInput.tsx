...
export default function CodeInput({
  ...
  const {
    ...
    isSuccess,
    error,
  } = api.entryCode.createCode.useMutation({
    onSuccess: () => {
                      ...
                      <div className="bg-sky-700 px-4 py-6 sm:px-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              type="button"
                              className="relative rounded-md bg-sky-700 text-sky-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white"
                        ...
                        <div className="mt-1">
                          <p className="text-sm text-sky-300">
                            Fill in the information below and then hit save.
                            Temporary codes and automatically generated codes
                            coming soon!
                          </p>
                        </div>
                      </div>
                      <div className="flex flex-1 flex-col justify-between">
                        <div className="divide-y divide-gray-200 px-4 sm:px-6">
                          <div className="space-y-6 pb-5 pt-6">
                            ...
                            {errorMsg.length !== 0 && (
                              <p className=" w-full animate-pulse px-8 text-center text-rose-600">
                                {errorMsg}
                              </p>
                            )}
